    ...
    <SectionWrapper>
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <h3 className="col-span-1 text-start text-base xl:text-lg font-normal text-slate-500 pt-2 uppercase">
            Education:{" "}
          </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <h3 className="col-span-1 text-start text-base xl:text-lg font-normal text-slate-500 uppercase">
            Achievements:{" "}
          </h3>
