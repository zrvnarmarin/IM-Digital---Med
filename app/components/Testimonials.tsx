...
export default function Testimonials() {
  return (
    <section className="flex gap-8 h-full flex-col md:flex-col py-12  bg-[#FFFFFF]">
          ...
          <div className="flex w-full items-center rounded-b p-4 lg:w-3/5 lg:rounded-r lg:rounded-bl-none sm:px-8 sm:py-6 lg:px-12 lg:py-12 xl:px-12 xl:py-10">
            <div className="grid gap-y-8">
              <p className="text-[#555f60] text-start text-sm font-medium">
                <span className="-ml-1">“</span>{testimonialData.testimonial}<span className="-ml-1">“</span>
              </p>
            ...
            />
                ...
                <div>
                  <p className="text-start text-md font-semibold">{testimonialData.personFullName}</p>
